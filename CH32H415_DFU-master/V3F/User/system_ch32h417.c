...
// #define SYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSE       350000000
#define SYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSI       350000000
// #define SYSCLK_300M_CoreCLK_V5F_300M_V3F_150M_HSE       300000000
...
#elif defined SYSCLK_400M_CoreCLK_V5F_400M_V3F_200M_HSE

uint32_t SystemClock = SYSCLK_400M_CoreCLK_V5F_400M_V3F_200M_HSE;         /* System Clock Frequency */
uint32_t SystemCoreClock = 200000000;

#elif defined SYSCLK_300M_CoreCLK_V5F_300M_V3F_150M_HSE
uint32_t SystemClock = SYSCLK_300M_CoreCLK_V5F_300M_V3F_150M_HSE;         /* System Clock Frequency */
uint32_t SystemCoreClock = 150000000;

#elif defined SYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSE
uint32_t SystemClock = SYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSE;         /* System Clock Frequency */
uint32_t SystemCoreClock = 175000000;

#elif defined SYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSI
uint32_t SystemClock = SYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSI;         /* System Clock Frequency */
uint32_t SystemCoreClock = 175000000;
...
#elif defined SYSCLK_400M_CoreCLK_V5F_400M_V3F_200M_HSE
static void SetSYSCLK_400M_CoreCLK_V5F_400M_V3F_200M_HSE( void );


#elif defined SYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSI
static void SetSYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSI( void );

#elif defined SYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSE
static void SetSYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSE( void );

#elif defined SYSCLK_300M_CoreCLK_V5F_300M_V3F_150M_HSE
static void SetSYSCLK_300M_CoreCLK_V5F_300M_V3F_150M_HSE( void );
...
#elif defined SYSCLK_400M_CoreCLK_V5F_400M_V3F_200M_HSE
    SetSYSCLK_400M_CoreCLK_V5F_400M_V3F_200M_HSE();
#elif defined SYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSE
    SetSYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSE();
#elif defined SYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSI
    SetSYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSI(  );

#elif defined SYSCLK_300M_CoreCLK_V5F_300M_V3F_150M_HSE
    SetSYSCLK_300M_CoreCLK_V5F_300M_V3F_150M_HSE();
...
static void SetSYSCLK_400M_CoreCLK_V5F_400M_V3F_200M_HSE(void)
{
  ...
  *(vu32*)SYS_CFGR0_BASE = tmp;
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /* Select FLASH clock frequency*/
    FLASH->ACTLR = FLASH_ACTLR_LATENCY_HCLK_DIV4;
...
/*********************************************************************
 * @fn      SYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSE
 *
 * @brief   Sets System clock frequency to 350MHz.
 *          Sets V5F Core clock frequency to 350MHz.
 *          Sets V3F Core clock frequency to 175MHz.
 *          configure HCLK prescalers.
 *
 * @return  none
 */
static void SetSYSCLK_350M_CoreCLK_V5F_350M_V3F_175M_HSE(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    /* configure PLL Clock */  
    RCC->PLLCFGR &= (uint32_t)((uint32_t)~(RCC_PLLMUL)); 
    RCC->PLLCFGR |= (uint32_t)RCC_PLLMUL14;   
    RCC->PLLCFGR &= (uint32_t)((uint32_t)~(RCC_PLL_SRC_DIV)); 
    RCC->PLLCFGR |= (uint32_t)RCC_PLL_SRC_DIV1;
    RCC->PLLCFGR &= (uint32_t)((uint32_t)~(RCC_PLLSRC)); 
    RCC->PLLCFGR |= (uint32_t)RCC_PLLSRC_HSE;
